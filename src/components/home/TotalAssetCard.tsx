    ...
    <>
      <div className="mx-4 mb-3 bg-white rounded-2xl p-5 shadow-sm">
        <div className="flex items-center justify-between mb-1">
          ...
          <button onClick={() => setHidden(!hidden)} className="text-[#8b95a1] p-1">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex-1 bg-[#3182f6] text-white rounded-xl py-3 text-sm font-semibold active:bg-[#1b64da] transition-colors"
          >
            송금
          </button>
